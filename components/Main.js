      ...
      return (
            <div className="panel panel-default">
                ...
                <div className="panel-body text-center">
                  ...
                  <h1>Home (was Address:)</h1>

		  <Link to='Register'><button  id="registerHere"type="submit">Register Here!</button></Link>
		  <Link to='Login'> <button id="loginHere" type="submit">Login Here!</button></Link>
